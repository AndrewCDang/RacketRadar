...
const CardProfiles = ({
                ...
                >
                    <div className="card-graph-racket-dot">
                        <div className="card-graph-dot-bg">
                            <div
                                style={{
                                    backgroundImage: `radial-gradient(at 25% 100%, hsla(183,95%,43%,1) 0px), 
        ...
        const updateFav = async () => {
            try {
                ...
                if (!response.ok) {
                    ...
                    if (error.type == "limit") {
                        dispatch({
                            ...
                            payload:
                                "Too many of the same requests. (≖_≖ )\nTry again later.",
                        });
                    }
                ...
                if (type == "added") {
                    dispatch({
                        type: "clientNotification",
                        payload: `${label} added to Favourites`,
                    });
                }
    ...
    const clientNotification = useCallback(
        (name, id) => {
            if (!state.wishRackets.includes(id)) {
                dispatch({
                    type: "clientNotification",
                    payload: `${name} added to Wish-list`,
                });
            }
        },
        [state.wishRackets]
    ...
    return (
        <article
            ...
            ref={(el) => (invsRef.current[index + 1] = el)}
            className="card-box"
            key={index}
        >
            <div
                ...
                onClick={(e) => {
                    const newArray = [...cardToggle];
                    newArray[index] = !newArray[index];
                    setCardToggle(newArray);
                    const newStyleArray = [...cardStyle];
                    newStyleArray[index] =
                        imgRefs.current[index].offsetHeight -
                        contentRef.current[index].offsetHeight;
                    setcardStyle(newStyleArray);
                }}
            ...
            <content
                style={{
                    transform: cardToggle[index]
                        ? `translateY(${cardStyle[index]}px)`
                        : `translateY(0px)`,
            ...
            >
                ...
                <div
                    ...
                    style={{
                        ...
                        overflow: "hidden",
                        maxHeight: cardHeightToggle
                            ? cardTextHeight[index]
                                ? maxHeight
                                : "1000px"
                            : `${copyHeightRef.current.offsetHeight + 48}px`,
                    }}
                >
                ...
                <article className="card-graph-main-container">
                    <article className="card-graph">
                        ...
                        <div className="card-graph-text stiff">
                            High Stiffness
                        </div>
                        <div className="card-graph-text flex">High Flex</div>
                        <div className="card-graph-text heavy">
                            H<span>ead</span>
                            <br></br>Heavy
                        </div>
                        <div className="card-graph-text light">
                            H<span>ead</span>
                            <br></br>Light
                        </div>
                ...
                >
                    <div className="chart-group">
                        ...
                        <div className="chart-container">
                            <svg
                                className="chart-back-container"
                                viewBox="0 0 36 36"
                            >
                                <path
                            ...
                            <div className="chart-score">
                                <div>
                                    <div>{el.stiff}%</div>
                                    <div className="chart-circle-text bold">
                                        Stiffness
                                    </div>
                                </div>
                            </div>
            ...
            <div
                className="card-linear"
                ref={(el) => (linearRefs.current[index] = el)}
                style={{
                    opacity: cardToggle[index] ? "0" : 1,
                    transition: "opacity 0.3s ease",
                }}
            ...
            <aside className="card-circle-container">
                ...
                <div className="card-circle c-2" title="Wish Racket">
                    <div
                        ...
                        onClick={() => {
                            dispatch({ type: "wishRackets", payload: el._id });
                            toggleHeart();
                            clientNotification(el.name, el._id);
                        }}
                    >
                        <svg
                            className={`card-svg svg-heart ${
                                clickedHeart ? "clickSvg" : null
                            }`}
                            data-name="Layer 1"
                            viewBox="0 0 666.67 597.43"
                        >
                            <defs>
                                <linearGradient
                                    id="MyGradient"
                            ...
                            <path
                                ...
                                className="cls-1"
                                d="M80.87,331.56l191.21,205.83c33.08,35.61,89.44,35.61,122.52,0l191.21-205.83c63.38-68.22,63.38-178.84,0-247.06-63.38-68.22-166.14-68.22-229.52,0h0c-12.39,13.34-33.51,13.34-45.9,0h0c-63.38-68.22-166.14-68.22-229.52,0-63.38,68.22-63.38,178.84,0,247.06Z"
                            />
                            <path
                                style={{
                                    stroke:
                ...
                <div className="card-circle c-2" title="Favourite-list Racket">
                    <div
                        className="card-outline"
                        onClick={() => {
                            dispatch({ type: "favRackets", payload: el._id });
                            toggleStar();
                            appendFavWish("fav", el._id, el.label);
                        }}
                    >
                        <svg
                            className={`card-svg fav-heart ${
                                clickedStar ? "clickSvg" : null
                            }`}
                            viewBox="0 0 80 80"
                            xmlns="http://www.w3.org/2000/svg"
                        >
