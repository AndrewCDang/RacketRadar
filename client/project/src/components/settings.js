...
function Settings(){
    ...
    const [state, dispatch] = useContext(RacketContext)
        ...
        const rangeFill = useRef({ref1: null, ref2: null, ref3: null, ref4:null})
    ...
    return(
        <section style={{zIndex: 11}} className='settings-container'>
            < StickyFilter filterRef={filterRef} NONE={NONE} inputMin={inputMin} inputMax={inputMax} rangeFill={rangeFill} rangeMin={rangeMin} rangeMax={rangeMax} bestSellingCheck={bestSellingCheck} currentlySelected={currentlySelected} setFilterValues={setFilterValues}/>
            {/* < UserFav /> */}
            < UserPref />
        </section>
    )
