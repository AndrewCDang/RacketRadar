...
const UserWish = ({userWishRef}) => {    
    ...
    return(
        <article ref={userWishRef}   className='userFav-container' style={{display: wishToggle? 'block' : 'none', transition: 'all 0.6s ease-out'} }>
            <section className='userFav-section'>
                <div className='userFav-title'>My Racket Wish-list</div>
                <div className="f-close-container" title='Close' onClick={()=>dispatch({type:'wishToggle'})}>
                ...
                <div className="userFav-Scroll">
                    {
                    racketWishList ? racketWishList.map((el,index)=>{
                        return(
                            <section key={index} className='userFav-item'>
                                <div className='userFav-svg-container'>
                                    ...
                                    <div className='userFav-svg-ctn' title="Remove from Wish-list" onClick={()=>{dispatch({type:'wishRackets', payload: el._id})}}>
                    ...
                    <div className='userFav-item'>
                        <p className='userFav-txt'>No rackets in Wish-list</p>
                    </div>
                }
                </div>
            </section>
