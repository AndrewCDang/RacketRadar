    ...
    return (
        <main className="main-community">
            <h2 className="com-title">
                Check out the <a> Top 10 Most Favourited</a> Rackets
            </h2>
            {comFav ? (
                        ...
                        <section className="com-fav-column">
                            {comFav.map((el, index) => {
                                return (
                                    <section
                                        key={index}
                                        className="com-fav-item-container"
                                    >
                                        <Link
                                            to={`/racket/${el.label}`}
                                            ...
                                            <div className="reactLink">
                                                ...
                                                <div className="com-fav-content">
                                                    ...
                                                    <div className="com-fav-count-container">
                                                        ...
                                                        <p className="com-fav-count-text">
                                                            {el.favouritesCount}
                                                        </p>
                                                    </div>
                                                </div>
